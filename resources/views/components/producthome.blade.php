<section id="product" class="product py-5 mt-5">
    <div class="container-lg">
        ...
        Kami memiliki suatu kebanggaan khusus untuk menghadirkan produk-produk yang tak hanya istimewa, tetapi juga memberi dampak positif bagi UMKM Karangjambe.
        </p>
        @if($products->isEmpty())
