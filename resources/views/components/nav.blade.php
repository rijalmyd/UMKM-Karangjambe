    ...
    <div class="container-lg px-lg-0">
        <div class="container-lg row p-0 m-0 justify-content-between align-items-center mx-auto">
            <div class="col-lg-2 col-5 d-flex align-items-center head">
                ...
                <header>
                    <h1>
                        <a href="{{route('home')}}"><span>U</span>M<span>K</span>M<span style="font-size: 14px;">Karangjambe</span></a>
                    </h1>
                </header>
            </div>
            <div class="collapse navbar-collapse col-lg-6 search-wrap" id="searches">
