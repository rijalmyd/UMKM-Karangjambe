...
<nav>
    <div class="flex px-8 sm:px-12 py-4 items-center relative justify-between">
        ...
        <a class="text-2xl">
            <span class="text-blue-700">U</span>M<span class="text-blue-700">K</span>M<span style="font-size: 16px;">Karangjambe</span>
        </a>
        ...
        <div class="mx-2 flex-1" id="indicators-carousel" data-carousel="static">
            ...
            <div id="detail1" class="">
                <div class="duration-700 ease-in-out h-fit">
                    ...
                    <p class="font-medium text-gray-500 text-md my-6"><span class="text-black">{{ $product->description }}</span></p>
                </div>
            </div>
            ...
            <div class="flex space-x-1 items-center">
                ...
                <p class="font-semibold text-gray-500 text-md">Dikirim dari <span class="text-black">Wanadadi, Banjarnegara</span></p>
            </div>
            <div class="flex space-x-1 items-center">
                ...
                <p class="font-semibold text-gray-500 text-md">Ongkir Reguler <span class="text-black">10rb - 23rb</span></p>
            </div>
    ...
    <footer class="p-4 bg-[#123] sm:p-6 mt-10">
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-400 ">
                            <li class="mb-4">
                                <a href="#" class="hover:underline">UMKM Karangjambe</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center ">© 2024 <a href="https://flowbite.com" class="hover:underline">KPM UNSIQ 63 Karangjambe</a>. All Rights Reserved.
                </span>
